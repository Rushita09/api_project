...
import 'package:api_project/insert_user.dart';
...
class _ApiState extends State<ApiCall> {
  ...
  Future<http.Response> deleteUserFromWeb(id) async {
    var response = await http.delete(
        Uri.parse("https://6318505ef6b281877c68d779.mockapi.io/user/$id"));
  ...
  Future<http.Response> getDataFromWebServer() async {
    var response = await http
        .get(Uri.parse("https://6318505ef6b281877c68d779.mockapi.io/user"));
